...
- Keep customer data, credentials, machine-specific paths and unrelated game assets out of commits. The owner authorized public release of this workflow repository with its existing historical Furuyoni case studies on 2026-09-11; preserve their separate rights notice. This does not authorize adding unrelated private assets. Use synthetic test images under ignored jobs/ or temporary directories for automated tests.
